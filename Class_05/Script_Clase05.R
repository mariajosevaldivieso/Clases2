...
covid<-fread(input ="Class_05/2020-04-08-CasosConfirmados.csv") # fread me permite cargar bases muy pesadas
str(covid)
sapply(covid,FUN = class) # me da la categoria de las columnas

covid[,`Casos Confirmados`:=as.numeric(`Casos Confirmados`)] # cambio el formato de la variable casos confirmados a numerico, las lineas pasan a Na
